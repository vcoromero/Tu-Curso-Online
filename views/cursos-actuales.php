...
$obj=new mCursos();
$data=$obj->getCursosActivos();
?>
<div style="text-align: center"class="container">
    <div class="row">
        <div class="col-md-12">
            <h2>Cursos actuales, ya puedes ver sus videos</h2>
        </div>
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-body">    
                        ...
                        <a class="btn btn-primary btn-block btn-lg" href="?sec=cursoActual&id=<?php echo $row['idcursos']?>" role="button">Ver</a> 
                    </div>
                </div>    
            </div>
            <?php endforeach;?>
